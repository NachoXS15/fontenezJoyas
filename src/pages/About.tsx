...
export default function About() {
    return (
        <Layout>
            ...
            <section className="w-full pt-20 flex items-center flex-col justify-center" style={{ fontFamily: 'garamond-premier-pro' }}>
            ...
            <section className="w-full h-fit pb-10 px-3 lg:px-24 bg-purplemain flex flex-col items-center justify-center" style={{ fontFamily: 'garamond-premier-pro', clipPath: 'polygon(50% 10%, 100% 0, 100% 100%, 0 100%, 0 0)' }}
            >
                <p className="text-white text-2xl lg:text-3xl text-center mt-44">Fonteñez Joyas es una empresa familiar, fundada por Pedro Fonteñez, comenzó abriendo un taller de orfebrería en el año 1924.
                ...
                <div className="w-full px-2 mt-10 bg-purplemain">
                    <div className="w-full h-96 flex px-6 md:px-20 items-center justify-center bg-center bg-cover" style={{ fontFamily: 'garamond-premier-pro', backgroundImage: `url(${bannerImg7})` }}>
                        <h2 className="text-white text-xl md:text-4xl text-center">El mismo enseña a su hijo Pedro, el cual sigue sus pasos creando, innovando, y trabajando con pasión y dedicación para continuar esa línea de plateros-orfebres</h2>
                    </div>
                </div>
            </section>
        </Layout>
