...
export default function Header() {
    ...
    return (
        <>
            <header className='bg-purplemain text-white flex justify-between items-center py-6 px-20 md:py-4 md:px-7 md:justify-around select-none drop-shadow-sm'>
                <NavLink to="/">
            ...
            {isClick && (
                <div className='md:hidden bg-slate-200 h-fit py-9 bottom-0'>
                    ...
                    <div className='flex flex-col mt-3'>
                        <NavLink className="hover:scale-105 transition my-2 mx-9 text-2xl text-purplemain" style={{ fontFamily: 'Mundial' }} to="/productos">Productos</NavLink>
                        <NavLink className="hover:scale-105 transition my-2 mx-9 text-2xl text-purplemain" style={{ fontFamily: 'Mundial' }} to="/about">Nosotros</NavLink>
                    </div>
                </div>
            )}
        </>
