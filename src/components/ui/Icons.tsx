...
export function MenuIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#0A77BE" className="size-12">
...
export function Cancel({ size, color }: props) {
    return (
...
export function SignOut({ size, color }: props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke={color} width={size} height={size}>
